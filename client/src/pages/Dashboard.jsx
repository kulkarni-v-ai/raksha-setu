...
const Dashboard = () => {
  ...
  const [user, setUser] = useState({ name: "Divya", email: "divya@rakshasetu.in" });
          ...
          <div className="main-content-flow">
            ...
            <div className="alerts-section animate-slide-up" style={{ animationDelay: '0.35s', padding: '0 1rem 1.5rem' }}>
              ...
              <div className="alerts-list">
                 <div className="alert-item glass" style={{ borderRadius: '1rem', padding: '1rem', border: '1px solid rgba(255,255,255,0.4)', background: 'rgba(255,255,255,0.6)' }}>
                    <div className="alert-dot emergency"></div>
                    <div className="alert-content">
                      <p style={{ fontWeight: 700 }}>Medical team dispatched</p>
                      <span style={{ fontSize: '0.75rem', opacity: 0.7 }}>SOS response active • Just now</span>
                    </div>
                 </div>
              </div>
            </div>
